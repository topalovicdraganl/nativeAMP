...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -ffunction-sections -fdata-sections -Wall -Wextra -Os -flto -ffat-lto-objects
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.5
 PARAMETER HW_INSTANCE = Dual_Timer_Counter_5
END
